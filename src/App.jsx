...
const App = () => {
  ...
  const handleSaveNewQuestion = async () => {
    ...
    try {
      const response = await axios.post(
        "https://campusquery-backend-1.onrender.com/save-question",
        newEntry
      );
  ...
  useEffect(() => {
    fetch("https://campusquery-backend-1.onrender.com/get_questions")
      .then((res) => res.json())
  ...
  const handleUpdate = () => {
    ...
    fetch("https://campusquery-backend-1.onrender.com/add_question", {
      method: "POST",
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        "https://campusquery-backend-1.onrender.com/ask",
        {
          query: question,
        }
      );
  ...
  const fetchAllQuestions = async () => {
    try {
      const response = await axios.get(
        "https://campusquery-backend-1.onrender.com/admin/questions",
        {
